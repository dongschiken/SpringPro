...
<div>
  ...
  <form action="/board/register" method="post">
     ...
     <input type="hidden" name="keyword" value="${ criteria.keyword }" style="padding: 7px">
	 <input type="hidden" name="type" value="${ criteria.type }" style="padding: 7px">
...
<script>
	...
	$("tfoot button").on("click", function(){
		...
		if(operation === 'modify'){							
			...
			let keyword = $("input[type='hidden'][name='keyword']").clone();
			let type = $("input[type='hidden'][name='type']").clone();
