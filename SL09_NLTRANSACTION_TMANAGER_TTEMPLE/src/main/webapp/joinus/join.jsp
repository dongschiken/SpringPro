						...
						<div id="join-form" class="join-form margin-large" >						
							<dl class="join-form-row">
								...
								<dd class="join-form-data">
									<input type="text" name="id" value="daetu01"/>
							...
							<dl class="join-form-row birthday">
								...
								<dd class="join-form-data">								
	                                <span>
	                                    ...
	                                    <input type="text" id="month" value="10" />월
							...
							<dl class="join-form-row">
								...
								<dd class="join-form-data">
									<input type="text" name="email" value="don@naver.com"/>
								</dd>
							</dl>
							<dl class="join-form-row">
								<dt class="join-form-title">
								...
								<dd class="join-form-data habit">
									...
									<input type="checkbox" name="habit" id="movie" value="music" checked="checked"/><label for="movie">영화</label>
									<input type="checkbox" name="habit" id="trip" value="musice" checked="checked"/><label for="trip">여행</label>
								</dd>
							</dl>						
						</div>
						<div id="buttonLine">
