...
public class NoticeDaoImpl implements NoticeDao {
	...
	public void insertAndPointUpOfMember(NoticeVO notice, String id) throws ClassNotFoundException, SQLException {
		...
		String sql1 = "INSERT INTO NOTICES"
				...
				+ " VALUES( "
				+ "(SELECT NVL(MAX(TO_NUMBER(SEQ)),0)+1 FROM NOTICES), :title, :content, 'daetu01', SYSDATE, 0, :filesrc)";
		...
		TransactionDefinition definetion = new DefaultTransactionDefinition();
		TransactionStatus status = this.transactionManager.getTransaction(definetion );
		try {
			SqlParameterSource parameterSource= new BeanPropertySqlParameterSource(notice);
			...
			//System.out.println( ">>>>>>> " +  this.npJdbcTemplate.update(sql2,  paramSource ) ); 
